...
Working_by_Educ_Model=zeros(5)
Working_by_Age_Model=zeros(10)
Working_by_Exp_Model=zeros(3)
Wages_by_Educ__Model=zeros(5)
Wages_by_Age=zeros(10)
Transition_Matrix_model =zeros(4)


Working_by_Educ_Model[1]=Working_Average+ m1[1]
Working_by_Educ_Model[2]=_Model=Working_Average_under_12+ m1[2]
Working_by_Educ_Model[3]=Working_Average_12+m1[3]
Working_by_Educ_Model[4]=Working_Average_13_15 + m1[4]
Working_by_Educ_Model[5]=Working_Average_16_plus +  m1[5]

working_by_age_model=working_by_age_data.+ m2

Working_by_Exp_Model[1]= Working_exp_10_or_less +m3[1]
Working_by_Exp_Model[2]=Working_exp_11_to_20 + m3[2]
Working_by_Exp_Model[3]=Working_exp_21_plus + m3[3]

Wages_by_Educ__Model[1]=Wages_average+m4[1]
Wages_by_Educ__Model[2]= Wage_Average_educ_under_12+m4[2]
Wages_by_Educ__Model[3]= Wage_Average_educ_12+m4[3]
Wages_by_Educ__Model[4]= Wage_Average_educ_13_15 + m4[4]
Wages_by_Educ__Model[5]==Wage_Average_educ_16_plus + m4[5]
